...
"""Verify that starting rcncoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rcncoin with -h for help text")
        ...
        self.log.info("Start rcncoin with -version for version information")
        ...
        self.log.info("Start rcncoind with -fakearg to make sure it does not start")
