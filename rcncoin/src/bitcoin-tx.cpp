...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rcncoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rcncoin-tx [options] <hex-tx> [commands]  Update hex-encoded rcncoin transaction\n" +
            "or:     rcncoin-tx [options] -create [commands]   Create hex-encoded rcncoin transaction\n" +
            "\n";
