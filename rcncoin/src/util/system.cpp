...
const char * const BITCOIN_CONF_FILENAME = "rcncoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RCNcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/RCNcoin";
#else
    // Unix-like
    return pathRet / ".rcncoin";
#endif
#endif
}
