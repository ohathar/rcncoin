Contributing to RCNcoin Core
============================

The RCNcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the RCNcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/rcncoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to rcncoin-qt
...
The following applies to code changes to the RCNcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall RCNcoin
Network Protocol consensus changes.

Whether a pull request is merged into RCNcoin Core rests with the project merge
...
Patches that change RCNcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the RCNcoin consensus, it must have been
...
The project leader is the release manager for each RCNcoin Core release.
