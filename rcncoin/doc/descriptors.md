# Support for Output Descriptors in RCNcoin Core

Since RCNcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing RCNcoin Core wallets, a convenience function `combo` is
